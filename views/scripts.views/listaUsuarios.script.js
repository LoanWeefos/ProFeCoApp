function mostrarListaUsuarios() {
    ...
    fetch(`http://localhost:8080/api/users`, {
        ...
        .then(data => {
            ...
            dialogboxhead.innerHTML = '<i class="fa fa-shopping-cart" aria-hidden="true"></i> Lista de usuarios registrados:';
            ...
            data.forEach(elemento => {
                let nombre;
                if(elemento.tipo === 'MERCADO'){
                    nombre = elemento.Mercado.nombre
                }else if(elemento.tipo === 'CONSUMIDOR'){
                    nombre = elemento.Consumidor.nombre
                }else{
                    nombre = 'ADMIN'
                }
